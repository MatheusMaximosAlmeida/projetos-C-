...
namespace prjAcademiaTB
{
    class ServidorSQL
    {
        ...
        {
            string banco = Environment.CurrentDirectory + "\\academia.sqlite";
            string sql = String.Format("Data Source = {0}; version=3",banco);
        ...
        private void criarTabelas()
        {
            try
            {
                string sql = "CREATE TABLE IF NOT EXIST ALUNO (" + 
